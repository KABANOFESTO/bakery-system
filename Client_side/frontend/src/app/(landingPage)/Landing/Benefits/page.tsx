      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 transform transition-all hover:scale-105">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6">Good Breads</h3>
            <p className="text-gray-600 mt-2">
              Made to order the same day or the day before it was shipped.
            </p>
          </div>

          {/* Right Column */}
          <div className="bg-white shadow-lg rounded-lg p-6 transform transition-all hover:scale-105">
            <h3 className="text-xl font-semibold text-gray-800">Free Delivering</h3>
            <p className="text-gray-600 mt-2">

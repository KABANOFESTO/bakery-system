...
const Careers: React.FC = () => {
  return (
    <div className="min-h-screen bg-white py-20 px-6 sm:px-10 max-w-4xl mx-auto" style={{ padding: "150px 20px" }}>
      <h1 className="text-4xl font-bold text-amber-900 mb-8 text-center">Careers at Bakery ineza</h1>

      <p className="mb-6 text-gray-700">
        Are you passionate about bread, sustainability, and making a difference? Bakery Ineza is always on the lookout for
      ...
      <p className="text-gray-700">
        At Bakery Ineza, we believe in equal opportunities, fair treatment, and building a culture where everyone thrives.
        Join us on our mission to share the best of Rwandan Tasty bread with the world.
      </p>
    </div>
  );
};

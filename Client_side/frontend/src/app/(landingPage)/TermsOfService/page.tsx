  ...
  return (
    <div className="min-h-screen bg-white py-20 px-6 sm:px-10 max-w-4xl mx-auto" style={{ padding: "150px 20px" }}>
      ...
      <p className="mb-6 text-gray-700">
        By accessing or using the Bakery ineza website, you agree to comply with and be bound by these
        Terms of Service. All purchases and interactions are subject to our privacy and refund policies.
      </p>
      <p className="mb-6 text-gray-700">
        You agree not to misuse the services or violate any laws in your jurisdiction. Bakery Ineza reserves

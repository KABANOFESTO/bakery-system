  ...
  return (
    <div className="min-h-screen bg-white py-20 px-6 sm:px-10 max-w-4xl mx-auto" style={{ padding: "150px 20px" }}>
      ...
      <p className="mb-6 text-gray-700">
        At Bakery Ineza, we strive for your satisfaction. If you are not fully satisfied with your order,
      ...
      <p className="mb-6 text-gray-700">
        Please contact us at <a className="text-amber-800 underline" href="mailto:marcellinabimana@gmail.com">info@inezabakery.com</a>
